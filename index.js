...
/////////////////
const BotName = 'BGSSKY BOT'; 
const instagram = 'https://instagram.com/bgs_rmdhan'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@bgs_rmdhan')
